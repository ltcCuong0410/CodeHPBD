const contentLetterSrart_actived =
  "ngày đặc biệt cùng một người đặc biệt , 1 món quà nhỏ tớ dành cho cậu - 04/10 "; //Lời mở đầu cho bức thư
const mainContentLetter =
  "Hãy vui vẻ và cười nhiều cậu nhé , mong cuộc sống sau này k quá bất công với cậu , học giỏi trở thành 1 bác sĩ tốt , nhớ giữ gìn sức khỏe , hãy cầm dt lên nt hay gọi điện cho tớ lúc câu có chuyện buồn hay cảm thấy tâm trạng k được thoải mái nhé happy birth day !!!."; //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/38.jpg";
